...
//	_type _typeof(Ast* expr, stack<_scope>& scope_stack, function_table& functions);
...
//	_type infer_type(Ast* expr, stack<_scope>& scope_stack, function_table& functions);
...
//	_type infer_return_type_from_last_stmt(Ast* stmt, stack<_scope>& scope_stack, function_table& functions);
//
...
//	void typecheck_statement(Ast* stmt, _fn& fn, stack<_scope> scope_stack, function_table& functions);
...
//	void typecheck_expression(Ast* expr, _fn& fn, stack<_scope> scope_stack, function_table& functions);
//	_type _typecheck_expression(Ast* expr, _fn& fn, stack<_scope> scope_stack, function_table& functions);
//	/*
//	
