...
//}
//
//_type _semantic_analyzer::infer_return_type_from_last_stmt(Ast* stmt, stack<_scope>& scope_stack, function_table& functions)
//{
//	_type inferred_type;
//
//	/*
...
//}
//
//_type _semantic_analyzer::infer_type(Ast* expr, stack<_scope>& scope_stack, function_table& functions)
//{
...
//}
//
//_type _semantic_analyzer::_typeof(Ast* expr, stack<_scope>& scope_stack, function_table& functions)
//{
//	switch (expr->ast_type) {
//	case AST_VAR: {
//		auto&& var = (_var*)expr;
...
//}
//
//void _semantic_analyzer::typecheck_statement(Ast* stmt, _fn& fn, stack<_scope> scope_stack, function_table& functions)
//{
//	switch (stmt->ast_type) {
//	case AST_RETURN: {
...
//}
//
//void _semantic_analyzer::typecheck_expression(Ast* expr, _fn& fn, stack<_scope> scope_stack, function_table& functions)
//{
...
//}
//
//_type _semantic_analyzer::_typecheck_expression(Ast* expr, _fn& fn, stack<_scope> scope_stack, function_table& functions)
//{
