/* Generated by re2c 1.3 on Wed Jun 17 14:30:42 2020 */
#line 1 "lexer.re"
...
case 7: if (scanner->end <= scanner->cursor) goto yyeof7; goto yyFillLabel7;
case 8: if (scanner->end <= scanner->cursor) goto yyeof8; goto yyFillLabel8;
}
