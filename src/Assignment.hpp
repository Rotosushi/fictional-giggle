...
protected:
  ...
  virtual void substitute_internal(string& id, shared_ptr<Ast>* term, shared_ptr<Ast>& value, Environment& env) override;
  virtual bool appears_free_internal(string& id) override;
