...
bool speculate_term(Parser* p, Scanner* s)
{
  ...
  */
  ...
  (i am sure this is the case for the speculation functions,
   as they don't need to build any data-structures. the other
   parser functions require more consideration.)
  */
